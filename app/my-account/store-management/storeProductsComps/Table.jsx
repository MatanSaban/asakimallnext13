						...
						{products.map((product) => {
							return (
								<tr id={product.id} key={product.id}>
									...
									<td style={{padding:'0'}} className="mainImage"><div><Image src={product.mainImage} width={100} height={100} alt={product.name + ' Main Image'}/><span className="icons"><i onClick={(e) => props.handleCell(e)} className="watchIcon" title="צפייה">{<AiOutlineEye/>}</i></span></div></td>
									...
									<td className="shortDesc"><div><span className="shortDesc">{props.trimString(product.shortdescription, 20)}</span> <span className="icons"><i onClick={(e) => props.handleCell(e)} className="watchIcon" title="צפייה">{<AiOutlineEye/>}</i></span></div></td>
									<td className="longDesc"><div><span className="longDesc">{props.trimString(product.description, 20)}</span> <span className="icons"><i onClick={(e) => props.handleCell(e)} className="watchIcon" title="צפייה">{<AiOutlineEye/>}</i></span></div></td>
